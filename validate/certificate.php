...
<head>
    ...
    <link rel="icon" href="https://www.edvicon.org/img/favicon.png">
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="https://www.edvicon.org/img/logo.png" alt="" style="width: 40%;">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="log_chat_area d-flex align-items-center">
                                <div class="live_chat_btn">
                                    <a class="boxed_btn_green" href="https://tawk.to/Edvicon">
                        ...
                        <div class="single_border">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-6 col-md-8 col-lg-6">
                                    <div class="chat">
                                        <a class="boxed_btn_green2" href="https://www.edvicon.org/contact.php">
                                                Contact Edvicon
                                        </a>
                                    </div>
                                </div>
